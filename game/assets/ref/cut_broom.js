// 빗자루(qltwkfn) 교체 — 원본(641x641, 투명 배경)의 여백을 잘라
// 32x32 격자(기존 broom.png 규격)에 꽉 차게 앉힌다.
// 다시 갈면 이 스크립트만 돌리면 된다. 원본: ref/src/ref_broom.png
// 실행: repo 루트에서  NODE_PATH=... node game/assets/ref/cut_broom.js
const fs = require('fs'), { PNG } = require('pngjs');
const im = PNG.sync.read(fs.readFileSync(__dirname + '/src/ref_broom.png'));
...
fs.writeFileSync(__dirname + '/../sprites/broom.png', PNG.sync.write(out));
console.log('broom.png 32x32 완료 (bbox', bw, 'x', bh, ')');
