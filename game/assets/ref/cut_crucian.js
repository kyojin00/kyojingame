// 붕어(qnddj) — 32x32 (기존 fish_crucian 규격).
// 다시 갈면 이 스크립트만 돌리면 된다. 원본: ref/src/ref_crucian.png
// 실행: repo 루트에서  NODE_PATH=... node game/assets/ref/cut_crucian.js
const fs = require('fs'), { PNG } = require('pngjs');
const im = PNG.sync.read(fs.readFileSync(__dirname + '/src/ref_crucian.png'));
...
fs.writeFileSync(__dirname + '/../sprites/fish_crucian.png', PNG.sync.write(out));
console.log('fish_crucian.png 32x32 완료 (bbox', bw, 'x', bh, ')');
