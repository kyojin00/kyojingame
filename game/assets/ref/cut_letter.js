// 편지 아이콘(buswl) — 원본(641x641, 투명 배경)의 여백을 잘라
// 32x32 격자에 꽉 차게 앉힌다. 이주 편지·할아버지의 편지 등
// 게임 속 모든 편지가 이 한 장을 같이 쓴다. 원본: ref/src/ref_letter.png
// 실행: repo 루트에서  NODE_PATH=... node game/assets/ref/cut_seed.js
const fs = require('fs'), { PNG } = require('pngjs');
const im = PNG.sync.read(fs.readFileSync(__dirname + '/src/ref_letter.png'));
...
fs.writeFileSync(__dirname + '/../sprites/icon_letter.png', PNG.sync.write(out));
console.log('icon_letter.png 32x32 완료 (bbox', bw, 'x', bh, ')');
