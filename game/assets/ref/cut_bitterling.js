// 납자루(wkfn) — 32x32 (기존 fish_bitterling 규격).
// 다시 갈면 이 스크립트만 돌리면 된다. 원본: ref/src/ref_bitterling.png
// 실행: repo 루트에서  NODE_PATH=... node game/assets/ref/cut_bitterling.js
const fs = require('fs'), { PNG } = require('pngjs');
const im = PNG.sync.read(fs.readFileSync(__dirname + '/src/ref_bitterling.png'));
...
fs.writeFileSync(__dirname + '/../sprites/fish_bitterling.png', PNG.sync.write(out));
console.log('fish_bitterling.png 32x32 완료 (bbox', bw, 'x', bh, ')');
