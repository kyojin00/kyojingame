...
def build_boy():
    ...
    HEAD = {
        1: (12, 21), 2: (10, 23), 3: (9, 24), 4: (8, 24), 5: (7, 25),
...
def build_girl():
    ...
    HEAD = {
        1: (12, 20), 2: (10, 22), 3: (9, 23), 4: (8, 24), 5: (7, 25),
...
HEAD_SIDE = {
    1: (12, 20), 2: (10, 21), 3: (9, 22), 4: (8, 22), 5: (7, 23),
...
def body_side(g, girl):
    ...
    for y in range(23, 27):        # 팔 — 몸통 한가운데. 네 칸이면 족하다
        hfill(g, y, 14, 17, 'T')
    for y in range(23, 32):        # 뒤쪽 이음선 — 팔이 몸 앞에 있다는 표시
        swap(g, 13, y, 't', 'y')
    hfill(g, 27, 14, 17, 'U')      # 소맷단
