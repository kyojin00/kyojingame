// 무지개송어(anwlrothddj) — 32x32 (기존 fish_rainbow 규격).
// 다시 갈면 이 스크립트만 돌리면 된다. 원본: ref/src/ref_rainbow.png
// 실행: repo 루트에서  NODE_PATH=... node game/assets/ref/cut_rainbow.js
const fs = require('fs'), { PNG } = require('pngjs');
const im = PNG.sync.read(fs.readFileSync(__dirname + '/src/ref_rainbow.png'));
...
fs.writeFileSync(__dirname + '/../sprites/fish_rainbow.png', PNG.sync.write(out));
console.log('fish_rainbow.png 32x32 완료 (bbox', bw, 'x', bh, ')');
