...
아홉 채 **전부 손그림**으로 바뀌었다 (`make_house.js`가 그리던 것은 이제
쓰지 않는다). 원본은 `assets/ref/src/ref_*.png`에 있다.

| 파일 | 들어간 크기 | 원본 비율 |
| --- | --- | --- |
| `house.png` 우리집 | 448 x **292** | 1.53 : 1 |
| `house_general.png` 잡화점 | 448 x **280** | 1.39 : 1 |
| `house_post.png` 우체국 | 391 x 384 | 1.02 : 1 |
| `house_lab.png` 연구소 | 269 x 384 | 0.70 : 1 |
| `house_smith.png` 대장간 | 296 x 384 | 0.77 : 1 |
| `house_ranch.png` 목장 상회 | 301 x 384 | 0.78 : 1 |
| `house_inn.png` 여관 | 305 x 384 | 0.79 : 1 |
| `house_library.png` 도서관 | 301 x 384 | 0.78 : 1 |
| `house_fish.png` 수산시장 | 244 x 384 | 0.64 : 1 |

앞의 둘만 세로를 못 채워서 나란히 놓으면 눈에 띄게 낮다. **이 둘은 다시
받아야 한다.** 나머지 일곱은 세로 384를 꽉 채웠다 — 가로가 244까지
좁아져도 낮아 보이지는 않는다.
