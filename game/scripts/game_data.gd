...
const HAIR_COL_NAMES := ["갈색", "검정", "짙은 갈색", "금발", "붉은 머리",
	"잿빛", "분홍", "하늘빛"]
# 옷·바지 [기본, 그늘, 밝은 면, 깊은 그늘, 아주 밝은 면] — 0번이 도트가 실제로
# 칠해진 표준 팔레트다.
#
# 한 벌에 **다섯 단**을 두는 이유: 세 단으로는 곡면에 그늘을 못 깐다. 접힌
# 자리와 빛을 정면으로 받는 자리가 같은 색이 되어 옷이 종이처럼 납작해 보였다.
# 뒤 두 단은 **기존 그늘·밝은 면에서** 계산한다 (기본색에서 뽑았더니 채도가
# 튀어 살결 깊은 그늘이 주황색이 됐다).
const APPEAR_SHIRT := [
	[[58, 88, 168], [38, 58, 120], [94, 126, 200], [27, 41, 84], [166, 184, 225]],
	[[214, 96, 116], [158, 60, 82], [232, 138, 152], [111, 42, 57], [242, 191, 198]],
	[[74, 138, 84], [48, 98, 60], [112, 176, 118], [34, 69, 42], [176, 212, 180]],
	[[206, 160, 60], [158, 114, 38], [232, 196, 102], [111, 80, 27], [242, 223, 171]],
]
const APPEAR_PANTS := [
	[[134, 88, 46], [98, 62, 32], [158, 108, 58], [69, 43, 22], [202, 174, 147]],
	[[64, 76, 116], [44, 54, 86], [88, 102, 144], [31, 38, 60], [163, 171, 194]],
	[[110, 110, 118], [80, 80, 88], [140, 140, 148], [56, 56, 62], [192, 192, 196]],
	[[126, 122, 72], [92, 88, 50], [154, 150, 96], [64, 62, 35], [199, 197, 168]],
]
const APPEAR_SHOES := [
	[[82, 53, 33], [56, 37, 25], [39, 26, 18]],
	[[50, 48, 52], [32, 31, 35], [22, 22, 24]],
	[[150, 58, 46], [106, 38, 30], [74, 27, 21]],
	[[60, 76, 140], [40, 52, 102], [28, 36, 71]],
]
# 피부 [기본, 밝은 면, 그늘, 볼, 입, 깊은 그늘, 아주 밝은 면] — 일곱 칸.
# (민머리는 정수리가 「밝은 면」, 머리 있는 쪽은 앞머리 밑이 「그늘」)
# 테두리(54,33,26)·눈(66,32,30)·눈썹(136,70,42)은 건드리지 않는다 —
# 피부를 아무리 어둡게 해도 얼굴선이 뭉개지지 않게.
const APPEAR_SKIN := [
	[[243, 159, 138], [250, 192, 170], [213, 116, 98], [235, 128, 114], [170, 84, 66], [184, 99, 83], [252, 217, 204]],
	[[252, 220, 203], [255, 240, 228], [232, 182, 166], [246, 196, 186], [205, 140, 126], [207, 153, 136], [255, 246, 239]],
	[[226, 166, 120], [240, 196, 156], [190, 126, 84], [220, 140, 104], [156, 92, 58], [156, 110, 80], [246, 220, 196]],
	[[198, 134, 92], [216, 166, 124], [158, 98, 62], [190, 112, 78], [128, 72, 44], [124, 87, 65], [232, 202, 176]],
	[[158, 102, 68], [182, 130, 94], [120, 72, 46], [150, 86, 58], [96, 54, 34], [94, 65, 48], [211, 180, 158]],
	[[116, 74, 50], [142, 98, 68], [84, 50, 32], [110, 62, 42], [68, 38, 24], [66, 45, 34], [187, 161, 143]],
]
# 머리카락 [기본, 밝은 면, 그늘, 깊은 그늘, 아주 밝은 면] — 네 벌 모두 바뀐다
# (4판부터. 옛 민머리 벌은 짧은 머리가 됐다)
const APPEAR_HAIR_COL := [
	[[118, 72, 40], [152, 100, 56], [86, 52, 30], [58, 35, 20], [195, 165, 140]],
	[[52, 46, 50], [78, 72, 78], [32, 28, 32], [22, 19, 22], [152, 149, 152]],
	[[84, 52, 32], [112, 74, 46], [58, 34, 20], [39, 23, 14], [172, 150, 134]],
	[[214, 170, 84], [240, 208, 132], [168, 124, 52], [114, 84, 35], [246, 228, 184]],
	[[190, 96, 48], [220, 134, 74], [142, 64, 30], [97, 44, 20], [235, 185, 150]],
	[[150, 148, 152], [186, 184, 188], [110, 108, 114], [75, 73, 78], [215, 214, 216]],
	[[214, 120, 160], [238, 160, 192], [164, 80, 118], [112, 54, 80], [245, 200, 218]],
	[[96, 140, 190], [132, 178, 220], [66, 100, 146], [45, 68, 99], [184, 210, 235]],
]
