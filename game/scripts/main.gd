...
const LANDMARKS := [
	...
	{"id": "falls", "name": "큰폭포", "kind": "landmark_falls",
		...
		# 물기둥이 지나는 칸까지 막는다 — 안 막으면 폭포 **속으로** 걸어
		# 들어가진다 (벼랑은 켜가 막아 주지만 그 밑 물줄기는 안 막힌다)
		"block": Rect2i(-4, -10, 9, 11), "clear": 13,
		"lake": [268, 36 + NORTH_PAD, 10.0, 6.0],
		"river": [266, 42 + NORTH_PAD, 246, 74 + NORTH_PAD, 2.0],
